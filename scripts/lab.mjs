...
file_put_contents('/artifacts/environment.json', json_encode(array('wp' => get_bloginfo('version'), 'theme' => get_stylesheet(), 'isBlockTheme' => wp_is_block_theme(), 'php' => PHP_VERSION, 'fixture' => true)));
`;
