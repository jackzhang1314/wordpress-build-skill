...
<nav id="primary-nav" class="primary-nav" aria-label="Primary"><?php
wp_nav_menu([
...
?></nav>
<a class="button header-cta" href="<?php echo esc_url(Starter\Theme\contact_url()); ?>">Request a quote</a>
</div></header>
<script>
document.querySelector('.nav-toggle')?.addEventListener('click',function(){
  var open=this.getAttribute('aria-expanded')==='true';
  this.setAttribute('aria-expanded',open?'false':'true');
  document.getElementById('primary-nav').classList.toggle('open',!open);
});
</script>
