<?php
/**
 * Product layout: standard catalogue presentation.
 *
 * @package b2b-starter
 */
...
<main id="main" class="shell">	<?php Starter\Theme\breadcrumbs(); ?>
	...
	<section class="section" aria-label="Product FAQ">
		<?php Starter\Theme\component_section_heading(['eyebrow' => 'FAQ', 'title' => 'Product questions']); ?>
		<?php Starter\Theme\component_faq(['rows' => $product['faq']]); ?>
	</section>
	<?php endif; ?>
	<?php
	if ($product['details']['has_content']) {
		ob_start(); the_content();
		Starter\Theme\component_rich_description(['title' => $product['details']['title'], 'content' => ob_get_clean()]);
	}
	?>
